...
const Home = () => {
  ...
  const fetchTasks = async () => {
    try {
      ...
      const url = hasFilter
        ? `https://taskmanager-beige-ten.vercel.app/https://taskmanager-beige-ten.vercel.app/api/tasks/filter`
        : `https://taskmanager-beige-ten.vercel.app/https://taskmanager-beige-ten.vercel.app/api/tasks`;
  ...
  const updateStatus = async (taskId, newStatus) => {
    try {
      await axios.patch(`https://taskmanager-beige-ten.vercel.app/https://taskmanager-beige-ten.vercel.app/api/tasks/${taskId}/status`, {
        status: newStatus,
      }, {
        headers: {
          Authorization: `Bearer ${token}`,
  ...
  const handleDelete = async (taskId) => {
    ...
    try {
        await axios.delete(`https://taskmanager-beige-ten.vercel.app/https://taskmanager-beige-ten.vercel.app/api/tasks/${taskId}`, {
        headers: {
            Authorization: `Bearer ${token}`,
        },
        });
