...
const Home = () => {
  ...
  const fetchTasks = async () => {
    try {
      ...
      const url = hasFilter
        ? `https://taskmanager-git-main-sagar-sharmas-projects-6f12e768.vercel.app/api/tasks/filter`
        : `https://taskmanager-git-main-sagar-sharmas-projects-6f12e768.vercel.app/api/tasks`;
  ...
  const updateStatus = async (taskId, newStatus) => {
    try {
      await axios.patch(`https://taskmanager-git-main-sagar-sharmas-projects-6f12e768.vercel.app/api/tasks/${taskId}/status`, {
        status: newStatus,
      }, {
        headers: {
          Authorization: `Bearer ${token}`,
  ...
  const handleDelete = async (taskId) => {
    ...
    try {
        await axios.delete(`https://taskmanager-git-main-sagar-sharmas-projects-6f12e768.vercel.app/api/tasks/${taskId}`, {
        headers: {
            Authorization: `Bearer ${token}`,
        },
        });
